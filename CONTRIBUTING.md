...
- **Study it.** The codebase demonstrates multi-crate Rust workspace patterns, deterministic simulation, WASM compilation, Monte Carlo statistical analysis, and containerized CI/CD with agent-driven development.
- **Use it.** You are free to use any component under the terms of the [Unlicense](LICENSE) or [MIT License](LICENSE-MIT).
