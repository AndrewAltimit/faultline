...
const BUNDLED_SCENARIOS: &[&str] = &[
    ...
    "arctic_sovereignty_standoff.toml",
    ...
    "drone_assisted_coup.toml",
    "drone_rogue_ap_bridge.toml",
    "drone_swarm_destabilization.toml",
    "europe_eastern_flank.toml",
    "europe_energy_sabotage.toml",
    "false_flag_demo.toml",
    "healthcare_ransomware_drone_convergence.toml",
    "maritime_strait_crisis.toml",
    "misattribution_demo.toml",
    ...
    "supply_chain_weaponization.toml",
