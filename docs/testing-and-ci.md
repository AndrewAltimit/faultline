...
| `verify-bundled` | `tools/ci/verify-bundled-scenarios.sh` — replay all 23 bundled scenarios for bit-identical output |
...
is caught here before it leaks into a release. Currently covers 23 bundled scenarios.
